...
- [Records](#records)
- [Search Object Records](#search-object-records)
...
**External Documentation:** [To understand objects and records, please have a look the documentation.](https://doc.clickup.com/8631005/d/h/87cpx-277156/93bf0c2e23177b0)
...
**External Documentation:** [To understand objects and records, please have a look at the documentation here ](https://doc.clickup.com/8631005/d/h/87cpx-277156/93bf0c2e23177b0)
...
| `searchableProperties` | array of string | Yes | Searchable Fields: Provide the field key of your object that you want to search on, using the format (custom_object.<object_name>.<field_key>). |
...
| `description` | string | No | Pet Object`s description |
| `locationId` | string | Yes | Location Id |
| `primaryDisplayPropertyDetails` | object | Yes |  |
...
**`primaryDisplayPropertyDetails` object properties:**
...
| Parameter | In | Type | Required | Description |
|-----------|-----|------|----------|-------------|
| `schemaKey` | path | string | Yes | The key of the Custom Object / Standard Object Schema. For custom objects, the key must include the “custom_objects.” prefix, while standard objects use their respective object keys. This information ... |
...
**External Documentation:** [Click here for more information](https://doc.clickup.com/8631005/d/h/87cpx-175596/e2f3e9f2e111d69/87cpx-275676)
...
**External Documentation:** [Click here for more information](https://doc.clickup.com/8631005/d/h/87cpx-175596/e2f3e9f2e111d69/87cpx-275236)
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `records` | array of object | No | Records |
...
| `owner` | array of string | Yes | Owner (User's id). Limited to 1 for now. Only Supported with custom objects |
| `followers` | array of string | Yes | Follower (User's ids). Limited to 10 for now |
...
|----------|------|----------|-------------|
| `id` | string | Yes | id of the record |
| `owner` | array of string | Yes | Owner (User's id). Limited to 1 for now . Only supported for custom objects for now |
| `followers` | array of string | Yes | Follower (User's ids). Limited to 10 and supported for custom objects for now |
| `properties` | string | Yes | Properties of the record |
...
| `lastUpdatedBy` | object | Yes |  |
| `searchAfter` | array of number | Yes |  |
