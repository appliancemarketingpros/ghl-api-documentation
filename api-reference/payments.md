...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `data` | array of object | Yes | An array of orders |
...
| `amountSummary` | object | No |  |
| `source` | object | No |  |
| `items` | array of string | No | Item details of the order. |
...
| `trackings` | array of object | Yes | Fulfillment tracking information |
| `items` | array of object | Yes | Fulfilled items |
| `notifyCustomer` | boolean | Yes | Need to send a notification to customer |

**`trackings` array item properties:**
...
|----------|------|----------|-------------|
| `status` | boolean | Yes | Status of api action |
| `data` | array of object | Yes | An array of fulfilled items |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `data` | array of object | Yes | An array of transactions |
...
|-----------|-----|------|----------|-------------|
| `altId` | query | string | Yes | AltId is the unique identifier e.g: location id. |
| `altType` | query | string (enum: `location`) | Yes | AltType is the type of identifier. |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `data` | array of object | Yes | An array of subscriptions |
...
| `status` | query | string (enum: `scheduled`, `active`, `expired`) | No | Filter coupons by status |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `data` | array of object | Yes | Array of coupon objects |
...
| `productIds` | array of string | No | Product Ids |
| `applyToFuturePayments` | boolean | No | Is Coupon applicable on upcoming subscription transactions Default: `True` |
| `applyToFuturePaymentsConfig` | object | No |  |
| `limitPerCustomer` | boolean | No | Limits whether a coupon can be redeemed only once per customer. Default: `False` |

**`applyToFuturePaymentsConfig` object properties:**
...
| `applyToFuturePaymentsConfig` | object | Yes |  |
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| `type` | string (enum: `funnel`, `website`, `invoice`, `calendar`, `text2Pay`, `document_contracts`, `membership`, `mobile_app`, `communities`, `point_of_sale`, `manual`, `form`, `survey`, `payment_link`, `external`) | Yes |  |
| `subType` | string (enum: `one_step_order_form`, `two_step_order_form`, `upsell`, `tap_to_pay`, `card_payment`, `store`, `contact_view`, `email_campaign`, `payments_dashboard`, `shopify`, `subscription_view`, `store_upsell`, `woocommerce`, `service`, `meeting`, `imported_csv`, `qr_code`, `saas_one_time`, `saas_subscription`) | No |  |
| `id` | string | Yes |  |
| `name` | string | No |  |
| `meta` | object | No |  |
